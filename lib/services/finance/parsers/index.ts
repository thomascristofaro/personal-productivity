...
import type { StatementReader } from "@/lib/services/finance/parsers/types"
...
const READERS: Record<FinanceProvider, StatementReader> = {
  REVOLUT: readRevolut,
  INTESA: readIntesa,
 ...
 * @returns a function taking the file's bytes and returning what it holds
 */
export function readerFor(provider: FinanceProvider): StatementReader {
