...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| §3, §7.2, §9.1 — **Anthropic Messages API**, `@anthropic-ai/sdk`, `claude-opus-5`, `ANTHROPIC_API_KEY`                                                         | **Google Gemini** through the Vercel AI SDK, `@ai-sdk/google`, `GOOGLE_AI_API_KEY`                          | The owner has a Google account and wants one API key with no service-account ceremony. §3 below records what makes this reversible.                                                                                                             |
...
| **`@ai-sdk/google`**, reading `GOOGLE_AI_API_KEY`                   | One environment variable. `@ai-sdk/google-vertex` needs a service-account private key in an env var, and does not accept the Agent Platform express-mode API key at all (vercel/ai#10058).                                                                                                            |
